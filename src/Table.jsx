...
function Table() {
  ...
  useEffect(() => {
    axios
      .post(`${api}/api/v2/filtered-data`, dfilter)
      .then((response) => {
      ...
      <Modal active={modalActive} setActive={setModalActive}>
        ...
        {filter == 0 && (
          <div className="filters">
            <button onClick={() => setFilter(1)}>города</button>
            <br />
            <button onClick={() => setFilter(2)}>года</button>
            <br />
            <button onClick={() => setFilter(3)}>разделы</button>
            <br />
            <button onClick={() => setFilter(4)}>строки</button>
            <br />
            <button onClick={() => setFilter(5)}>колонки</button>
            <br />
            <button className="submit-data" onClick={handleFilteredData}>
              применить
            </button>
          </div>
        )}
        {filter == 1 && (
          <div className="filter-content">
            ...
            <button className="button-back" onClick={() => setFilter(0)}>
              Назад
            </button>
          </div>
        )}
                ...
                .filter(
                  (row) =>
                    row
                      .toString()
                      .toLowerCase()
                      .includes(searchRow.toLowerCase()) // Исправлено
                )
                .map((row) => (
                  <div key={row}>
                    <label>
                ...
                .filter(
                  (column) =>
                    column
                      .toString()
                      .toLowerCase()
                      .includes(searchColumn.toLowerCase()) // Исправлено
                )
                .map((column) => (
                  <div key={column}>
                    <label>
